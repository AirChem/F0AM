...
H2  =  0.000000560.*M;
CH4 =  0.000001850.*M;
% disp('CAUTION: FOR F0AM-CRACMM1, CH4 MIXING RATIO IS FIXED AT 1850 PPBV AND H2 IS FIXED AT 560 PPBV, IN LINE WITH CMAQ ASSUMPTIONS.')
...
'IEPOXP'; 'AISO3NOSJ'; 'ASO4J'; 'AISO3OSJ'; 'VROCP6ALK'; ...
...
% 412, <HET_N02>
i=i+1;
Rnames{ 412} = 'NO2 = 0.50000*HONO +  0.50000*HNO3 ';
k(:,i) = (K_HETERO_NO2 ); 
Gstr{i,   1}='NO2';
fNO2(i)=fNO2(i)-1.0;
...
% 416, <HET_IEPOXOS>
i=i+1;
Rnames{ 416} = 'IEPOXP + ASO4J = AISO3OSJ ';
...
% 417, <ROCALK1c>
i=i+1;
Rnames{ 417} = 'VROCP6ALK + HO = VROCP6ALKP ';
k(:,i) = (  1.5300E-11 ); 
...
% 418, <ROCALK2c>
i=i+1;
Rnames{ 418} = 'VROCP5ALK + HO = VROCP5ALKP ';
k(:,i) = (  1.6800E-11 ); 
...
% 419, <ROCALK3c>
i=i+1;
Rnames{ 419} = 'VROCP4ALK + HO = VROCP4ALKP ';
k(:,i) = (  2.2400E-11 ); 
...
% 420, <ROCALK4c>
i=i+1;
Rnames{ 420} = 'VROCP3ALK + HO = VROCP3ALKP ';
k(:,i) = (  2.6700E-11 ); 
...
% 421, <ROCALK5c>
i=i+1;
Rnames{ 421} = 'VROCP2ALK + HO = VROCP2ALKP ';
k(:,i) = (  3.0900E-11 ); 
...
% 422, <ROCALK6c>
i=i+1;
Rnames{ 422} = 'VROCP1ALK + HO = VROCP1ALKP ';
k(:,i) = (  3.3800E-11 ); 
...
% 424, <ROCALK7c>
i=i+1;
Rnames{ 424} = 'VROCP6ALKP + NO = 0.72000*VROCP6ALKP2 +  0.28000*VROCP4OXY2 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 425, <ROCALK8c>
i=i+1;
Rnames{ 425} = 'VROCP5ALKP + NO = 0.72000*VROCP5ALKP2 +  0.28000*VROCP3OXY2 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 426, <ROCALK9c>
i=i+1;
Rnames{ 426} = 'VROCP4ALKP + NO = 0.72000*VROCP4ALKP2 +  0.28000*VROCP2OXY2 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 427, <ROCALK10c>
i=i+1;
Rnames{ 427} = 'VROCP3ALKP + NO = 0.72000*VROCP3ALKP2 +  0.28000*VROCP1OXY1 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 428, <ROCALK11c>
i=i+1;
Rnames{ 428} = 'VROCP2ALKP + NO = 0.72000*VROCP2ALKP2 +  0.28000*VROCP0OXY2 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 429, <ROCALK12c>
i=i+1;
Rnames{ 429} = 'VROCP1ALKP + NO = 0.72000*VROCP1ALKP2 +  0.28000*VROCN1OXY1 +  0.72000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 430, <HC1002>
i=i+1;
Rnames{ 430} = 'HC10P + NO = 0.74000*HC10P2 +  0.26000*ONIT +  0.74000*NO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 431, <ROCALK13c>
i=i+1;
Rnames{ 431} = 'VROCP6ALKP + NO3 = VROCP6ALKP2 + NO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 432, <ROCALK14c>
i=i+1;
Rnames{ 432} = 'VROCP5ALKP + NO3 = VROCP5ALKP2 + NO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 433, <ROCALK15c>
i=i+1;
Rnames{ 433} = 'VROCP4ALKP + NO3 = VROCP4ALKP2 + NO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 434, <ROCALK16c>
i=i+1;
Rnames{ 434} = 'VROCP3ALKP + NO3 = VROCP3ALKP2 + NO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 435, <ROCALK17c>
i=i+1;
Rnames{ 435} = 'VROCP2ALKP + NO3 = VROCP2ALKP2 + NO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 436, <ROCALK18c>
i=i+1;
Rnames{ 436} = 'VROCP1ALKP + NO3 = VROCP1ALKP2 + NO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 437, <HC1003>
i=i+1;
Rnames{ 437} = 'HC10P + NO3 = HC10P2 + NO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 438, <ROCALK19c>
i=i+1;
Rnames{ 438} = 'VROCP6ALKP + HO2 = VROCP3OXY2 ';
k(:,i) = (  2.1700E-11 ); 
...
% 439, <ROCALK20c>
i=i+1;
Rnames{ 439} = 'VROCP5ALKP + HO2 = VROCP2OXY2 ';
k(:,i) = (  2.2000E-11 ); 
...
% 440, <ROCALK21c>
i=i+1;
Rnames{ 440} = 'VROCP4ALKP + HO2 = VROCP1OXY1 ';
k(:,i) = (  2.2500E-11 ); 
...
% 441, <ROCALK22c>
i=i+1;
Rnames{ 441} = 'VROCP3ALKP + HO2 = VROCP0OXY2 ';
k(:,i) = (  2.2600E-11 ); 
...
% 442, <ROCALK23c>
i=i+1;
Rnames{ 442} = 'VROCP2ALKP + HO2 = VROCN1OXY1 ';
k(:,i) = (  2.2700E-11 ); 
...
% 443, <ROCALK24c>
i=i+1;
Rnames{ 443} = 'VROCP1ALKP + HO2 = VROCN2OXY2 ';
k(:,i) = (  2.2700E-11 ); 
...
% 445, <ROCALK25c>
i=i+1;
Rnames{ 445} = 'VROCP6ALKP2 = HO2 + VROCP3OXY2 ';
k(:,i) = (  1.8800E-01 ); 
...
% 446, <ROCALK26c>
i=i+1;
Rnames{ 446} = 'VROCP5ALKP2 = HO2 + VROCP2OXY2 ';
k(:,i) = (  1.8800E-01 ); 
...
% 447, <ROCALK27c>
i=i+1;
Rnames{ 447} = 'VROCP4ALKP2 = HO2 + VROCP1OXY1 ';
k(:,i) = (  1.8800E-01 ); 
...
% 448, <ROCALK28c>
i=i+1;
Rnames{ 448} = 'VROCP3ALKP2 = HO2 + VROCP0OXY2 ';
k(:,i) = (  1.8800E-01 ); 
...
% 449, <ROCALK29c>
i=i+1;
Rnames{ 449} = 'VROCP2ALKP2 = HO2 + VROCN1OXY1 ';
k(:,i) = (  1.8800E-01 ); 
...
% 450, <ROCALK30c>
i=i+1;
Rnames{ 450} = 'VROCP1ALKP2 = HO2 + VROCN2OXY2 ';
k(:,i) = (  1.8800E-01 ); 
...
% 451, <HC1005>
i=i+1;
Rnames{ 451} = 'HC10P2 = HO2 + VROCP4OXY2 ';
k(:,i) = (  1.8800E-01 ); 
Gstr{i,   1}='HC10P2';
...
% 452, <ROCALK31c>
i=i+1;
Rnames{ 452} = 'VROCP6ALKP2 + NO = 0.14000*VROCP2OXY2 +  0.86000*NO2 +  0.86000*VROCP3OXY2 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 453, <ROCALK32c>
i=i+1;
Rnames{ 453} = 'VROCP5ALKP2 + NO = 0.14000*VROCP1OXY3 +  0.86000*NO2 +  0.86000*VROCP2OXY2 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 454, <ROCALK33c>
i=i+1;
Rnames{ 454} = 'VROCP4ALKP2 + NO = 0.14000*VROCP0OXY2 +  0.86000*NO2 +  0.86000*VROCP1OXY1 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 455, <ROCALK34c>
i=i+1;
Rnames{ 455} = 'VROCP3ALKP2 + NO = 0.14000*VROCN1OXY1 +  0.86000*NO2 +  0.86000*VROCP0OXY2 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 456, <ROCALK35c>
i=i+1;
Rnames{ 456} = 'VROCP2ALKP2 + NO = 0.14000*VROCN2OXY2 +  0.86000*NO2 +  0.86000*VROCN1OXY1 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 457, <ROCALK36c>
i=i+1;
Rnames{ 457} = 'VROCP1ALKP2 + NO = VROCN2OXY2 +  0.86000*NO2 +  0.86000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 458, <HC1006>
i=i+1;
Rnames{ 458} = 'HC10P2 + NO = 0.12000*ONIT +  0.88000*NO2 +  0.88000*KET +  0.88000*HO2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 459, <ROCALK37c>
i=i+1;
Rnames{ 459} = 'VROCP6ALKP2 + NO3 = NO2 + VROCP3OXY2 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 460, <ROCALK38c>
i=i+1;
Rnames{ 460} = 'VROCP5ALKP2 + NO3 = NO2 + VROCP2OXY2 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 461, <ROCALK39c>
i=i+1;
Rnames{ 461} = 'VROCP4ALKP2 + NO3 = NO2 + VROCP1OXY1 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 462, <ROCALK40c>
i=i+1;
Rnames{ 462} = 'VROCP3ALKP2 + NO3 = NO2 + VROCP0OXY2 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 463, <ROCALK41c>
i=i+1;
Rnames{ 463} = 'VROCP2ALKP2 + NO3 = NO2 + VROCN1OXY1 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 464, <ROCALK42c>
i=i+1;
Rnames{ 464} = 'VROCP1ALKP2 + NO3 = NO2 + VROCN2OXY2 + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 465, <HC1007>
i=i+1;
Rnames{ 465} = 'HC10P2 + NO3 = NO2 + KET + HO2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 466, <ROCALK43c>
i=i+1;
Rnames{ 466} = 'VROCP6ALKP2 + HO2 = VROCP1OXY3 ';
k(:,i) = (  2.1700E-11 ); 
...
% 467, <ROCALK44c>
i=i+1;
Rnames{ 467} = 'VROCP5ALKP2 + HO2 = VROCP0OXY2 ';
k(:,i) = (  2.2000E-11 ); 
...
% 468, <ROCALK45c>
i=i+1;
Rnames{ 468} = 'VROCP4ALKP2 + HO2 = VROCN1OXY1 ';
k(:,i) = (  2.2500E-11 ); 
...
% 469, <ROCALK46c>
i=i+1;
Rnames{ 469} = 'VROCP3ALKP2 + HO2 = VROCN2OXY2 ';
k(:,i) = (  2.2600E-11 ); 
...
% 470, <ROCALK47c>
i=i+1;
Rnames{ 470} = 'VROCP2ALKP2 + HO2 = VROCN2OXY2 ';
k(:,i) = (  2.2700E-11 ); 
...
% 471, <ROCALK48c>
i=i+1;
Rnames{ 471} = 'VROCP1ALKP2 + HO2 = VROCN2OXY2 ';
k(:,i) = (  2.2700E-11 ); 
...
% 472, <HC1008>
i=i+1;
Rnames{ 472} = 'HC10P2 + HO2 = VROCP2OXY2 ';
k(:,i) = (  2.6600E-13.*exp(  1.3000E+03./T) ); 
...
% 473, <ROCARO01>
i=i+1;
Rnames{ 473} = 'VROCP6ARO + HO = 0.84000*VROCP6AROP +  0.16000*HO2 +  0.16000*VROCP4OXY2 ';
k(:,i) = (  1.8100E-11 ); 
...
% 474, <ROCARO02>
i=i+1;
Rnames{ 474} = 'VROCP6AROP + HO2 = 0.05950*VROCP4OXY2 +  0.90480*VROCP1OXY3 +  0.03570*VROCN2OXY4 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 475, <ROCARO03>
i=i+1;
Rnames{ 475} = 'VROCP6AROP + NO = 0.00010*VROCP4OXY2 +  0.00180*VROCP2OXY2 +  0.00010*VROCN1OXY3 +  0.99800*NO2 +  0.99800*HO2 +  0.05940*BALD +  0.46930*GLY +  0.46930*MGLY +  0.46930*FURANONE +  0.46930*DCB2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 476, <ROCARO04>
i=i+1;
Rnames{ 476} = 'VROCP6AROP + NO3 = NO2 +  0.94050*HO2 +  0.05950*BALD +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 477, <ROCARO05>
i=i+1;
Rnames{ 477} = 'VROCP6AROP + MO2 = 0.68000*HCHO +  1.31050*HO2 +  0.32000*MOH +  0.05950*BALD +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 478, <ROCARO06>
i=i+1;
Rnames{ 478} = 'VROCP6AROP + ACO3 = 0.70000*MO2 +  0.94050*HO2 +  0.30000*ORA2 +  0.05950*BALD +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 479, <ROCARO11>
i=i+1;
Rnames{ 479} = 'VROCP5ARO + HO = 0.84000*VROCP5AROP +  0.16000*HO2 +  0.16000*VROCP3OXY2 ';
k(:,i) = (  1.8100E-11 ); 
...
% 480, <ROCARO12>
i=i+1;
Rnames{ 480} = 'VROCP5AROP + HO2 = 0.05950*VROCP3OXY2 +  0.90480*VROCP0OXY2 +  0.03570*VROCN2OXY4 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 481, <ROCARO13>
i=i+1;
Rnames{ 481} = 'VROCP5AROP + NO = 0.00010*VROCP3OXY2 +  0.00180*VROCP1OXY3 +  0.00010*VROCN2OXY4 +  0.99800*NO2 +  0.99800*HO2 +  0.05940*VROCP4OXY2 +  0.46930*GLY +  0.46930*MGLY +  0.46930*FURANONE +  0.46930*DCB2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 482, <ROCARO14>
i=i+1;
Rnames{ 482} = 'VROCP5AROP + NO3 = NO2 +  0.94050*HO2 +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 483, <ROCARO15>
i=i+1;
Rnames{ 483} = 'VROCP5AROP + MO2 = 0.68000*HCHO +  1.31050*HO2 +  0.32000*MOH +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 484, <ROCARO16>
i=i+1;
Rnames{ 484} = 'VROCP5AROP + ACO3 = 0.70000*MO2 +  0.94050*HO2 +  0.30000*ORA2 +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 485, <ROCARO21>
i=i+1;
Rnames{ 485} = 'NAPH + HO = 0.84000*NAPHP +  0.16000*HO2 +  0.16000*VROCP3OXY2 ';
k(:,i) = (  2.3100E-11 ); 
...
% 486, <ROCARO22>
i=i+1;
Rnames{ 486} = 'NAPHP + HO2 = 0.05950*VROCP3OXY2 +  0.90480*VROCP1OXY3 +  0.03570*VROCN2OXY8 ';
k(:,i) = (  2.9100E-13.*exp(  1.3000E+03./T) ); 
...
% 487, <ROCARO23>
i=i+1;
Rnames{ 487} = 'NAPHP + NO = 0.05950*VROCP4OXY2 +  0.00180*VROCP2OXY2 +  0.00010*VROCN2OXY8 +  0.99800*NO2 +  0.99800*HO2 +  0.46930*GLY +  0.46930*MGLY +  0.46930*FURANONE +  0.46930*DCB2 ';
k(:,i) = (  2.7000E-12.*exp(  3.6000E+02./T) ); 
...
% 488, <ROCARO24>
i=i+1;
Rnames{ 488} = 'NAPHP + NO3 = NO2 +  0.94050*HO2 +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  2.3000E-12 ); 
...
% 489, <ROCARO25>
i=i+1;
Rnames{ 489} = 'NAPHP + MO2 = 0.68000*HCHO +  1.31050*HO2 +  0.32000*MOH +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  3.5600E-14.*exp(  7.0800E+02./T) ); 
...
% 490, <ROCARO26>
i=i+1;
Rnames{ 490} = 'NAPHP + ACO3 = 0.70000*MO2 +  0.94050*HO2 +  0.30000*ORA2 +  0.05950*VROCP4OXY2 +  0.47020*GLY +  0.47020*MGLY +  0.47020*FURANONE +  0.47020*DCB2 ';
k(:,i) = (  7.4000E-13.*exp(  7.6500E+02./T) ); 
...
% 491, <ROCOXY1c>
i=i+1;
Rnames{ 491} = 'VROCN2OXY8 + HO = HO +  0.08540*VROCN2OXY8 +  0.25810*DCB1 +  0.25810*MEK +  0.25810*ACD +  0.25810*ALD +  0.25810*MO2 +  0.25810*ETHP +  0.25810*HC3P +  0.25810*MEKP ';
k(:,i) = (  5.9000E-11 ); 
...
% 492, <ROCOXY2c>
i=i+1;
Rnames{ 492} = 'VROCN2OXY4 + HO = HO +  0.46400*VROCN2OXY8 +  0.19770*VROCN2OXY4 +  0.01210*VROCN1OXY6 +  0.01520*VROCN1OXY3 +  0.06240*VROCP0OXY4 +  0.03880*VROCP1OXY3 +  0.04910*VROCP2OXY2 +  0.03980*VROCP3OXY2 +  0.01830*VROCP4OXY2 +  0.03080*OP3 +  0.00400*OP2 +  0.07940*DCB1 +  0.07940*MEK +  0.07940*KET +  0.07940*ACD +  0.07940*ALD +  0.07940*MO2 +  0.07940*ETHP +  0.07940*HC3P +  0.07940*MEKP +  0.07940*HC5P +  0.07940*KETP ';
k(:,i) = (  6.0700E-11 ); 
...
% 494, <ROCOXY4c>
i=i+1;
Rnames{ 494} = 'VROCN1OXY6 + HO = HO +  0.20360*VROCN2OXY8 +  0.00710*VROCN2OXY4 +  0.18400*DCB1 +  0.18400*MEK +  0.18400*KET +  0.18400*ACD +  0.18400*ALD +  0.18400*MO2 +  0.18400*ETHP +  0.18400*HC3P +  0.18400*MEKP +  0.18400*HC5P ';
k(:,i) = (  5.6300E-11 ); 
...
% 497, <ROCOXY7c>
i=i+1;
Rnames{ 497} = 'VROCP0OXY4 + HO = HO +  0.28220*VROCN2OXY8 +  0.11650*VROCN2OXY4 +  0.03200*VROCN1OXY6 +  0.01830*VROCN1OXY3 +  0.00110*VROCP0OXY4 +  0.06600*VROCP2OXY2 +  0.05350*VROCP3OXY2 +  0.02460*VROCP4OXY2 +  0.00540*OP2 +  0.10680*DCB1 +  0.10680*MEK +  0.10680*KET +  0.10680*ACD +  0.10680*ALD +  0.10680*MO2 +  0.10680*ETHP +  0.10680*HC3P +  0.10680*MEKP +  0.10680*HC5P +  0.10680*KETP ';
k(:,i) = (  5.1700E-11 ); 
...
% 503, <ROCOXY13c>
i=i+1;
Rnames{ 503} = 'VROCP4OXY2 + HO = HO +  0.01170*VROCN2OXY8 +  0.01670*VROCN2OXY4 +  0.04800*VROCN1OXY6 +  0.02460*VROCN1OXY3 +  0.08810*VROCP0OXY4 +  0.09160*VROCP1OXY3 +  0.00730*VROCP1OXY1 +  0.09720*VROCP2OXY2 +  0.04560*VROCP3OXY2 +  0.00240*VROCP4OXY2 +  0.04790*VROCP5OXY1 +  0.07450*VROCP6OXY1 +  0.06070*OP3 +  0.01550*OP2 +  0.07860*DCB1 +  0.07860*HKET +  0.07860*MEK +  0.07860*ACD +  0.07860*ALD +  0.07860*MO2 +  0.07860*ETHP +  0.07860*HC3P +  0.07860*MEKP +  0.17300*HC5P ';
k(:,i) = (  3.1200E-11 ); 
...
% 506, <ROCOXY16c>
i=i+1;
Rnames{ 506} = 'OP3 + HO = HO +  0.11880*VROCN2OXY8 +  0.00080*VROCN2OXY4 +  0.03900*VROCN1OXY6 +  0.01140*VROCP0OXY4 +  0.22660*DCB1 +  0.22660*MEK +  0.22660*ACD +  0.22660*ALD +  0.22660*MO2 +  0.22660*ETHP +  0.22660*HC3P +  0.22660*MEKP ';
k(:,i) = (  4.6900E-11 ); 
...
%  35, <R031>
%i=i+1;
%Rnames{  507} = 'TRPN = HO2 + NO2 +  0.20000*ALD +  0.80000*KET ';
%k(:,i) = (JONIT_RACM2 ); 
%Gstr{i,   1}='ONIT';
%fONIT(i)=fONIT(i)-1.0;
%fHO2(i)=fHO2(i)+  1.000;fNO2(i)=fNO2(i)+  1.000;fALD(i)=fALD(i)+  0.200;fKET(i)=fKET(i)+  0.800;
